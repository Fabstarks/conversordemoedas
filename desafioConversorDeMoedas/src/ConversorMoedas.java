...
public class ConversorMoedas {
    ...
    private static final String API_URL = "https://v6.exchangerate-api.com/v6/9d400f53206bbae05cacb2f3/latest/USD";

    public static Map<String, Double> taxasDeConversao() throws IOException, InterruptedException {
    ...
    public static double converterMoeda(double valor, String moedaOrigem, String moedaDestino) throws IOException, InterruptedException {
        Map<String, Double> taxasDeConversao = taxasDeConversao();
